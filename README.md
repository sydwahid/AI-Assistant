...
## 🏗️ Architecture (4 Microservices)
...
| 🗄️ **REST API** | Express 5, MongoDB, Mongoose | Authentication (JWT), Chat History, Stripe Payments, Gemini AI fallback |
...
- **🗣️ Always-on Voice Mode**: Uses Web Speech API for continuous dictation. Wake words ("Hey Jarvis") trigger background commands.
...
- **🎨 Spline 3D UI**: Implements interactive 3D assets in the browser for a premium, futuristic aesthetic.
